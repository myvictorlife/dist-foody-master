...
var RestaurantComponent = (function () {
    ...
    RestaurantComponent.prototype.populate = function (restaurant) {
        ...
        console.log(this.bkpCategories);
